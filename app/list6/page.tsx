            ...
            <div className="w-full max-w-[1800px]">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4" style={{ perspective: '1000px' }}>
                    {services.map((service, index) => {
                        ...
                        // First two rotate left, middle is flat, last two rotate right
                        let rotateY = 0;
                        ...
                        return (
                            ...
                            >
                                {/* SVG Background & Border - Desktop Only */}
                                ...
                                {/* Standard Card Background - Mobile/Tablet Only */}
                                ...
                                <div className="relative h-full p-6 flex flex-col justify-center z-10">
                                    {/* Icon */}
                                    <div
                                        className={`w-14 h-14 rounded-xl border flex items-center justify-center mb-6 transition-all duration-500 flex-shrink-0 overflow-hidden ${isHovered
