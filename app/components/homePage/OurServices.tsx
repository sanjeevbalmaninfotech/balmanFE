            ...
            <div className="relative w-full mx-auto px-4 sm:px-8 lg:px-[120px]">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                        <div className="w-10 h-0.5 bg-[#FF5900]" />
                        <span className="text-white font-['Plus_Jakarta_Sans'] text-base font-medium">
                            Our Services
                        </span>
                    </div>

                    {/* Main Heading */}
                    <h2 className="text-white font-['Plus_Jakarta_Sans'] text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                ...
                <div className="flex items-center justify-center py-6 md:py-10">
                    ...
                    >
                        {ourServices.map((service, index) => (
                            <SwiperSlide key={index}>
                                <div
                                    className={`
                    w-full h-full bg-black border border-[#ff6600] rounded-2xl 
                  ...
                  `}
                                ...
                                >
                                    {/* Icon Container */}
                                    <div className="w-12 h-12 md:w-14 md:h-14 bg-[#1a1a1a] border border-[#ff6600] rounded-xl flex items-center justify-center mb-5 md:mb-6">
