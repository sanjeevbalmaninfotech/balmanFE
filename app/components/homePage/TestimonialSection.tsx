      ...
      <div className="w-full bg-black flex items-center justify-center section-padding">
       ...
       h-[520px] sm:h-[560px] lg:h-[520px] xl:h-[495px] px-4 lg:px-0 "
          >
            {/* ===== LEFT PREVIEW ===== */}
            <div
              className="absolute left-0 top-1/2 -translate-y-1/2 w-[180px] h-[300px]
            ...
            {/* ===== RIGHT PREVIEW ===== */}
            <div
              className="absolute right-0 top-1/2 -translate-y-1/2 w-[180px] h-[300px]
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    i === currentIndex ? "bg-primary w-8" : "bg-gray-500 w-2"
                  }`}
                />
              ))}
            </div>
