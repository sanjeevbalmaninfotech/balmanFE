...
export default function ProcessSection({ data }: ProcessSectionProps) {
  return (
    <div className="bg-[#010101] container  mt-10 lg:mt-15">

      {/* Main Heading */}
      <h2 className="service-heading-h2 mb-2 lg:mb-4 text-left">
        {data.mainHeading}
      </h2>
          ...
          <div key={idx} className="relative">
            <div className="flex flex-col items-start text-left space-y-2">
              ...
              <div className="pt-2">
                ...
                <p className="service-body-text mt-2 mb-4 lg:mb-4 !text-[#B8B8B8] !text-[clamp(13px,2.5vw,15px)]">
                  {step.description}
                </p>
              </div>
            </div>
