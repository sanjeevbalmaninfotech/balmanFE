...
export default function AboutExperienceSection() {
  ...
  return (
    <section className="relative bg-black min-h-screen overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-orange-600 rounded-full blur-[150px] opacity-40"></div>
              ...
              <div className="flex flex-col gap-4 justify-end">
                ...
                <div className="bg-gray-900 border border-gray-800 flex flex-col justify-center px-4 py-3 rounded-[10px] w-[169px] h-[113px] ml-auto">
                  ...
                  <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <div key={star} className="w-6 h-1 bg-orange-500 rounded-full"></div>
                    ))}
                  </div>
                </div>
              </div>
