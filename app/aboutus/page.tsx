...
export default function AboutExperienceSection() {
  ...
  return (
    <>
      <Navbar />
      <section className="relative mt-14 bg-black min-h-screen overflow-hidden">
        ...
        <div className="relative w-full section-padding-x section-padding-y">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2
                className="font-['Plus_Jakarta_Sans'] font-bold text-start leading-[110%] tracking-tight mb-2 sm:mb-3 md:mb-4"
                style={{
                  fontSize: "clamp(24px, 5vw, 36px)",
                  backgroundImage: "radial-gradient(circle at center, #ffffff 0%, #c0c0c0 50%, #7f7f7f 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                }}
              >
                Crafting Ideas, Shaping Futures
              </h2>
